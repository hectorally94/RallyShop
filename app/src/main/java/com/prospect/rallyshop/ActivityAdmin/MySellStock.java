...
public class MySellStock extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_sell_stock);
    ...
    public void selectDrawerItem(MenuItem menuItem) {
        ...
        switch(menuItem.getItemId()) {
            ...
            default:
                ...
                Toast.makeText(MySellStock.this,"No Activity selected",Toast.LENGTH_LONG).show();

...
public class AddSuCategories extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_su_categories);
    ...
    public void selectDrawerItem(MenuItem menuItem) {
        ...
        switch(menuItem.getItemId()) {
            ...
            case R.id.viewUS:
                ...
                Intent intentviewUS = new Intent(getApplicationContext(), AboutUSAdmin.class);
                startActivity(intentviewUS);
                finish();
                break;
            case R.id.Quit:
            ...
            default:
                ...
                Toast.makeText(AddSuCategories.this,"No Activity selected",Toast.LENGTH_LONG).show();

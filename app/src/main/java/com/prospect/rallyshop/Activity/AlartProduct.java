...
public class AlartProduct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_alart_product);
    ...
    public void selectDrawerItem(MenuItem menuItem) {
        ...
        switch(menuItem.getItemId()) {
            ...
            case R.id.viewmystock:
                ...
                Intent intent11 = new Intent(getApplicationContext(), Stock.class);
            ...
            default:
                ...
                Toast.makeText(AlartProduct.this,"No Activity selected",Toast.LENGTH_LONG).show();
